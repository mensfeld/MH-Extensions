...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.rdoc", "README.md", "lib/acts_as_tree.rb", "lib/array.rb", "lib/date.rb", "lib/hash.rb", "lib/mh_extensions.rb", "lib/rand.rb", "lib/range.rb", "lib/string.rb", "lib/string_ext.rb"]
  s.files = ["CHANGELOG.rdoc", "Gemfile", "MIT-LICENSE", "README.md", "Rakefile", "init.rb", "lib/acts_as_tree.rb", "lib/array.rb", "lib/date.rb", "lib/hash.rb", "lib/mh_extensions.rb", "lib/rand.rb", "lib/range.rb", "lib/string.rb", "lib/string_ext.rb", "Manifest", "mh_extensions.gemspec"]
